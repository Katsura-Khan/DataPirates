...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        int x = fm.stringWidth("Registration Center SDUdent");
        ...
        setTitle(pad+"Registration Center SDUdent");
        ...
        l7 = new JLabel("SDU email");
        l7.setFont(new Font("Raleway", Font.BOLD, 20));

        l8 = new JLabel("Your status:");
        ...
        l12 = new JLabel("State(if you are an international student):");
        ...
        r3 = new JRadioButton("Local");
        r3.setFont(new Font("Raleway", Font.BOLD, 14));
        r3.setBackground(Color.WHITE);

        r4 = new JRadioButton("International");
